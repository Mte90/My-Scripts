...
os.remove(metadata['xesam:url'].replace('%23','#').replace('%28','(').replace('%5B','[').replace('%5D',']').replace('%2C',',').replace('%C3%89', 'É').replace('%C3%A9','é').replace('%29',')').replace('%27',"'").replace('%26','&').replace('%20',' ').replace('file://',''))
