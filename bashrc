...
alias phpdoc='phpcs -d memory_limit=512M --ignore=*cmb*,index.php,*.js,WP_*,CPT_*,*.css,Widgets-Helper,*_Core --standard=PHPDoc'
alias phpdoccbf='phpcbf -d memory_limit=512M --ignore=*cmb*,index.php,*.js,WP_*,CPT_*,*.css,Widgets-Helper,*_Core --standard=PHPDoc'
